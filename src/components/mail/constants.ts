...
export const GITDEV_EMAIL_RESET_PASSWORD_QUEUE = "email-reset-mq";
export const GITDEV_EMAIL_VERIFY_ACCOUNT_QUEUE = "email-verify-account-mq";
export const GITDEV_EMAIL_CHANGE_PASSWORD_QUEUE = "email-change-password-mq";
...
export const GITDEV_EMAIL_CHANGE_PASSWORD_JOB = "job-email-change-password";
